...
The first trusted GREEN run reached strict lint and exposed one redundant Ajv type argument. After that compiler-directed fix, the next trusted run reached TypeScript and exposed the `Object.fromEntries` key-narrowing boundary. The minimal type-safe intent was recorded in bot commit `20ac0ce9b884360c678b5341f11d9719aa92963e`, and the one-time workflow removed itself.
